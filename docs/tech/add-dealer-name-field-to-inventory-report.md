...
- How will the Dealer name field be validated for alphanumeric characters and common punctuation?
- What is the expected behavior when a user attempts to edit the Dealer name of an existing inventory item?